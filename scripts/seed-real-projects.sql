-- ============================================================
-- Seed des 3 vrais projets DEV.PRO
-- À coller dans : Supabase → SQL Editor → New query → Run
-- ============================================================

-- (Optionnel) Vide la table avant de réinjecter — décommentez si besoin
...
-- ─── Vérification ─────────────────────────────────────────
SELECT id, title, category, featured, "order"
FROM projects
ORDER BY "order" ASC;
